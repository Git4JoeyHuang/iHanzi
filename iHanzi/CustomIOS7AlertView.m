...
- (UIView *)createContainerView
{
    ...
    for (UIView* button in containerView.subviews) {
        if ([button isKindOfClass:[UIButton class]]) {
            [(UIButton*)button addTarget:self action:@selector(customIOS7dialogButtonTouchUpInside:) forControlEvents:UIControlEventTouchUpInside];
        }
    ...
    return [dialogContainer autorelease];
}
